...
- **スイッチの取り付け**
  ...
  - *ホットスワップ・ソケットの場合*: スイッチをホットスワップ・ソケットに差し込みます.<br/><div><img src="../img/kudox-full-switch1.jpg" alt="kudox full switches1" width="300"/>&nbsp;&nbsp;<img src="../img/kudox-full-switch2.jpg" alt="kudox full switches2" width="300"/></div>
- 下部ケースをスペーサーにネジ止めします.
